...
theMovieDb.common = {
  ...
  client: function(options, successCallback, errorCallback) {
    console.log(theMovieDb.common.base_uri + options.url)
    return request({
...
theMovieDb.authentication = {
  generateToken: function(success, error) {
    ...
    theMovieDb.common.client(
      {
        url:
          'authentication/token/new' + theMovieDb.common.generateQuery(),
      },
      success,
      error
    )
...
theMovieDb.certifications = {
  getList: function(success, error) {
    ...
    theMovieDb.common.client(
      {
        url:
          'certification/movie/list' + theMovieDb.common.generateQuery(),
      },
      success,
      error
    )
...
theMovieDb.find = {
  getById: function(options, success, error) {
    ...
    theMovieDb.common.client(
      {
        url:
          'find/' + options.id + theMovieDb.common.generateQuery(options),
      },
      success,
      error
    )
...
theMovieDb.lists = {
  getById: function(options, success, error) {
    ...
    theMovieDb.common.client(
      {
        url:
          'list/' + options.id + theMovieDb.common.generateQuery(options),
      },
      success,
      error
    )
...
theMovieDb.movies = {
  getById: function(options, success, error) {
    ...
    return theMovieDb.common.client(
      {
        url:
          'movie/' + options.id + theMovieDb.common.generateQuery(options),
      },
      success,
      error
    )
  ...
  getNowPlaying: function(options, success, error) {
    ...
    theMovieDb.common.client(
      {
        url:
          'movie/now_playing' + theMovieDb.common.generateQuery(options),
      },
      success,
      error
    )
...
theMovieDb.search = {
  ...
  getCollection: function(options, success, error) {
    ...
    theMovieDb.common.client(
      {
        url:
          'search/collection' + theMovieDb.common.generateQuery(options),
      },
      success,
      error
    )
